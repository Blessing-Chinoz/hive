    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              <h2 className="text-xl lg:text-2xl font-bold leading-tight mb-1 text-blue-500">
                About Us
              </h2>
      ...
      <section className="relative py-20">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/80 text-lg">Simple, effective, human</p>
        </div>
      </section>
            ...
            <div className="relative overflow-hidden rounded-3xl shadow-2xl order-2 lg:order-1">
              ...
              <div className="absolute bottom-8 left-8 right-8">
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                  ...
                  <p className="text-white/90">Founder & Creative Lead</p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            {services.map((service, idx) => (
              <div
                key={idx}
                className={`grid lg:grid-cols-[200px_1fr] gap-8 p-8 rounded-3xl backdrop-blur-sm border ${
                  isDarkMode
                    ? "bg-white/5 border-white/10"
                    : "bg-white/50 border-gray-200/50"
                } hover:shadow-2xl transition-all duration-300 group`}
              >
                <div className="flex flex-col items-center lg:items-start justify-center">
                  <div className="w-20 h-20 bg-linear-to-r from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <service.icon className="w-10 h-10 text-white" />
                  </div>
                  <h3 className="text-xl font-bold text-blue-500 text-center lg:text-left">
                    {service.title}
                  </h3>
                </div>
      ...
      <section className="relative py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p
              className={`text-base ${themeClasses.textSecondary} mb-8 leading-relaxed max-w-2xl mx-auto`}
            >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                className={`relative bg-linear-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-8 py-3 rounded-2xl text-base font-bold transition-all transform hover:scale-105 shadow-lg overflow-hidden group`}
              >
